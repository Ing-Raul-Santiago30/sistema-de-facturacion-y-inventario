...
namespace FIVT
{
    public partial class FrmReporteClientesNombre : Form
    {
        public FrmReporteClientesNombre(string valor)
        {
            InitializeComponent();
            this.a = valor;
        }
        ...
        private void crystalReportViewer1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                String Query = "SELECT * FROM Tbl_Cliente where CNombres='" +Convert.ToString (a) + "'"; // ESTE ES NUESTRO QUERY
