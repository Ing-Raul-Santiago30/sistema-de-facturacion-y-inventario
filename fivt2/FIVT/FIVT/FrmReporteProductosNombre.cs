...
namespace FIVT
{
    public partial class FrmReporteProductosNombre : Form
    {
        public FrmReporteProductosNombre(string valor)
        {
            InitializeComponent();
            a = valor;
        }
        string a;
        private void FrmReporteProductosNombre_Load(object sender, EventArgs e)
        {
}
        ...
        private void crystalReportViewer1_Load(object sender, EventArgs e)
        {
            ...
            String Query = "SELECT * FROM Tbl_Productos where PNombres='" + (a) + "'"; // ESTE ES NUESTRO QUERY
