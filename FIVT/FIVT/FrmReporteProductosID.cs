...
namespace FIVT
{
    public partial class FrmReporteProductosID : Form
    {
        public FrmReporteProductosID(string valor)
        {
            InitializeComponent();
            this.a = valor;
        }
       ...
       private void crystalReportViewer1_Load(object sender, EventArgs e)
       {
           ...
           String Query = "SELECT * FROM Tbl_Productos where Pid='" + Convert.ToInt32(a) + "'"; // ESTE ES NUESTRO QUERY
        ...
        private void FrmReporteProductosID_Load(object sender, EventArgs e)
        {
